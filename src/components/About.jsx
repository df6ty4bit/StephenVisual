...
import editor1Photo from '../assets/editor1.jpg'; // Create src/assets/editor1.jpg
import editor2Photo from '../assets/editor2.jpg'; // Create src/assets/editor2.jpg
  ...
  return (
    <section className="about-section">
      ...
      <p style={{textAlign: 'center', maxWidth: '800px', margin: '0 auto 2rem'}}>
        StephenVisual is a leading photo editing and event coverage brand based in Nigeria,
        dedicated to creating stunning visuals and preserving precious memories.
        Founded by Stephen Okoro, our mission is to deliver excellence in every frame.
      </p>

      <h3>Our Philosophy</h3>
      <p style={{textAlign: 'center', maxWidth: '800px', margin: '0 auto 2rem'}}>
        We believe that every moment holds a unique story, and it's our privilege to tell that story through compelling imagery.
        Our approach combines artistic vision with technical precision, ensuring each client receives a personalized and unforgettable visual experience.
      </p>
